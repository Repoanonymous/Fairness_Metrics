...
class SampleDistortionMetric(DatasetMetric):
    ...
    def mean_euclidean_distance_difference(self, privileged=None):
        ...
        return (self.average(self.euclidean_distance, privileged=True) - 
                self.average(self.euclidean_distance, privileged=False))

    def mean_manhattan_distance_difference(self, privileged=None):
        """Difference of the averages."""
        return (self.average(self.manhattan_distance, privileged=True) - 
                self.average(self.manhattan_distance, privileged=False))

    def mean_mahalanobis_distance_difference(self, privileged=None):
        """Difference of the averages."""
        return (self.average(self.mahalanobis_distance, privileged=True) - 
                self.average(self.mahalanobis_distance, privileged=False))
